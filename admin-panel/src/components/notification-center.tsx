  ...
  useEffect(() => {
    setTimeout(() => {
      ...
      try {
        ...
        if (stored) {
          setNotifications(JSON.parse(stored).map((n: Notification) => ({
            ...n,
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent
        ...
        align="end"
        sideOffset={16}
        className="w-[380px] p-0 rounded-2xl border border-black/5 dark:border-white/5 bg-white dark:bg-[#1C1C1E] shadow-2xl overflow-hidden animate-in slide-in-from-left-2 fade-in duration-200"
      >
        {/* Header */}
